...
namespace BannerNotificationCodeGenerator
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Banner Notification Code Generator"),
        ExportMetadata("Description", "Generates JavaScript code for banner notification based on a FetchXML query"),
    ...
    public class BannerNotificationCodeGenerator : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new BannerNotificationCodeGeneratorControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public BannerNotificationCodeGenerator()
        {
